class Validator {
    ...
    //Pravime vo sekoe pole od objektot da ima niz
    ...
    //Input Listener ni e potreben koga ke zapisime nesto, da dobieme povratna informacija
    inputListener() {
    ...
    validate(e) {
        ...
        //Go zemame momentalnoto pole, ona vo koe nesto sme napisale
        let field = e.target;
        let fieldName = field.getAttribute('name');
        let fieldValue = field.value;

        //Zapisuvame erorrs za sekoe fieldName ako imame
